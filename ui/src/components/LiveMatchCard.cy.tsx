...
describe('LiveMatchCard', () => {
  it('renders game type, map, and LIVE pill', () => {
    mountWithProviders(<LiveMatchCard match={mockLiveMatch} tick={0} />);
  ...
  it('shows avgRating in footer when provided', () => {
    mountWithProviders(<LiveMatchCard match={mockLiveMatch} tick={0} avgRating={1315} />);
  ...
  it('highlights a specific player', () => {
    mountWithProviders(
      <LiveMatchCard match={mockLiveMatch} tick={0} highlightProfileId={1001} />
    );
  ...
  it('renders team match with multiple players per team', () => {
    ...
    mountWithProviders(<LiveMatchCard match={teamMatch} tick={0} />);
