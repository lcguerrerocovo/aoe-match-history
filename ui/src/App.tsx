...
function App() {
  ...
  const [selectedMatchType, setSelectedMatchType] = useUrlState<string>({ key: 'type', defaultValue: '' });
  const [sortDirection, setSortDirection] = useUrlState<SortDirection>({ key: 'sort', defaultValue: 'desc' });
