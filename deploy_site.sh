...
echo "[deploy] Uploading UI from /app/site to gs://aoe2-match-history-site/"
gsutil -m cp -r /app/site/* gs://aoe2-match-history-site/
...
gsutil -m cp -r /app/site/assets/* gs://aoe2-match-history-site/assets/
gsutil -h "Cache-Control:no-cache, max-age=0" \
  cp data/matches/index.json gs://aoe2-match-history-site/data/matches/index.json
...
gsutil -h "Cache-Control:public, max-age=86400" cp data/100.json \
  gs://aoe2-match-history-site/data/100.json

# Make everything public
echo "[deploy] Setting public ACL on gs://aoe2-match-history-site"
